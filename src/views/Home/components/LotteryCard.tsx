...
import { Heading, Card, CardBody, Button, useModal } from '@coffeeswap/uikit'
...
const FarmedStakingCard = () => {
  ...
  const [onPresentBuy] = useModal(<BuyModal max={cakeBalance} tokenName="COFE" />)
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <Block>
          <Label>{TranslateString(552, 'COFE to Collect')}:</Label>
          <CakeWinnings />
        </Block>
        <Block>
